                ...
                <div class="card-content">
                  <div class="card-body">
                    <?php
                      ...
                      $sql = "SELECT * FROM example WHERE id={$filter}";
                      ...
                      <div class="row">
                        <div class="col-md-2 col-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder=""
                              name="fname-column" value="<?=$array['name']?>">
                          </div>
                        </div>
                        <div class="col-md col-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" placeholder=""
                              name="lname-column" value="<?=$array['title']?>">
                          </div>
                        </div>
                        <div class="col-md-12 col-12">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="information" rows="3"><?=$array['information']?></textarea>
                          </div>
                        </div>
